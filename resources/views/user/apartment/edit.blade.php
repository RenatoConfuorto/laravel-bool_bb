...
<div class="container-fluid">
  ...
  <form class="mt-3" action="{{ route('user.apartment.update', ['apartment' => $apartment->id]) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <div class="form-check">
        <input class="form-check-input" type="radio" name="visibility" id="visibilty-true" value="1" {{ ($apartment->visibility === 1) ? 'checked' : '' }}>
        <label class="form-check-label" for="visibility-true">
          Si
        </label>
      </div>
      <div class="form-check">
        <input class="form-check-input" type="radio" name="visibility" id="visibilty-false" value="0"  {{ ($apartment->visibility === 0) ? 'checked' : '' }}>
